...
const STRINGIFIERS = {
  ...
  tilt: v => `X: ${v.x}, Y: ${v.y}`,
  //Facility Edit
  administration: v => `administration: ${v.administration}, tration: ${v.tration}`,
  packages: v => `packages: ${v.packages}, kages: ${v.kages}`,
  transfers: v => `transfers: ${v.transfers}, Sfers: ${v.sfers}`,
  sales: v => `sales: ${v.sales}, Ales: ${v.ales}`,
  reports: v => `reports: ${v.reports}, Eports: ${v.eports}`,
  financials: v => `financials: ${v.financials}, Nancials: ${v.nancials}`,

    ...
    return [
      ...
      m('.blurb',
        ...
        m('p',
          ...
          'example: tracking the provenance of patienceio from catch to plate. ',
          'One day an application like this could be used by restaurants, ',
          'grocery stores, and their customers to ensure the patienceio they ',
          'purchase is ethically sourced and properly transported.'),
        m('p',
          'To use ',
          m('em', 'Patienceio'),
          ', create an account using the link in the navbar above. ',
          'Once logged in, you will be able to add new patienceio assets to ',
